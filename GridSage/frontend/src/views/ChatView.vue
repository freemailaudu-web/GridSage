<template>
  <div class="chat-view">
    <div class="main-split">
      <section class="chat-section">
          ...
          <div v-for="(msg, index) in messages" :key="index" :class="['message', msg.role]">
            ...
            <div class="content">
              ...
              <div v-if="msg.matchedSkills?.length" class="info-panel">
                <div class="panel-title">场景技能识别结果</div>
              ...
              <div v-if="msg.skillWarnings?.length" class="notice-panel warning">
                <div class="panel-title">Skill 提醒</div>
              ...
              <div v-if="msg.proposedStateSummary && Object.keys(msg.proposedStateSummary).length" class="info-panel">
                <div class="panel-title">本轮变更摘要</div>
        ...
        <div class="input-area">
          ...
          <div class="action-buttons">
            <el-button @click="openSkillsLibrary">场景技能库</el-button>
      ...
      <aside class="state-section">
        ...
        <div v-if="currentState" class="state-panel">
          <div class="panel-title">场景 / RL 配置</div>
          <div class="state-grid">
            <span>场景名称</span><strong>{{ currentState.scenario_name || '未命名场景' }}</strong>
            <span>算法</span><strong>{{ currentState.algo_name }}</strong>
            <span>执行模式</span><strong>{{ currentState.execution_mode }}</strong>
          </div>
          ...
          <div v-if="timeProfileRows.length" class="time-profile">
            <div class="panel-title">分时倍率曲线</div>
            <el-table :data="timeProfileRows" size="small" max-height="200" border>
              <el-table-column prop="hour" label="小时" width="70" />
              <el-table-column prop="load" label="负荷倍率" />
              <el-table-column prop="pv" label="光伏倍率" />
              <el-table-column prop="ev" label="EV 倍率" />
            </el-table>
          </div>
        </div>
      </aside>
    ...
    <el-dialog v-model="skillsDialogVisible" title="场景技能库" width="760px">
      <el-table :data="skills" height="360" highlight-current-row @row-click="selectSkill">
        ...
        <el-table-column prop="name_cn" label="中文名" width="170" />
        <el-table-column prop="category" label="类别" width="150" />
        <el-table-column prop="default_algorithm" label="默认算法" width="100" />
        <el-table-column prop="description_cn" label="简介" />
      </el-table>
